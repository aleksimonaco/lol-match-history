...
templates['searchresult'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.matches : depth0),{"name":"each","hash":{},"fn":container.program(4, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "    <div class=\"col-xs-12 col-md-6 col-md-offset-3 text-center\">\r\n        <h1>Total kills in last 10 matches</h1>\r\n        <canvas id=\"totalKills\"></canvas>\r\n    </div>\r\n";
  ...
  return "<!-- <div class=\"col-xs-12 col-sm-6\">\r\n"
    ...
    + "</div> -->\r\n\r\n<div class=\"row\">\r\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.matches : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.program(9, data, 0),"data":data})) != null ? stack1 : "")
    + "</div>\r\n";
},"useData":true});
})();